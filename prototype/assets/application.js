...
function(e) {
...
}(jQuery), typeof disqus_shortname != "undefined" && (DISQUSWIDGETS = function() {
    var e = {},
      t = function(e) {
        switch (e) {
          case 0:
      ...
      n = {
        getCount: function() {
          // var t = "http://" + disqus_shortname + ".disqus.com/count.js?q=1";
          // $("a[data-disqus-identifier]").each(function(n) {
          //   var r = $(this).data("disqus-identifier");
          //   t += "&" + n + "=" + 1 + "," + r, e[n] = this
          // });
          // var n = $("<script>").attr({
          //   async: "async",
        ...
        displayCount: function(n) {
          var r, i, s, o;
          for (r = 0; r < n.counts.length; r++) i = n.counts[r], s = e[i.uid], s && (o = t(i.comments), $(s).html(o))
        }
      };
    return n
  }(), $(document).ready(DISQUSWIDGETS.getCount)),
  function() {
    var e = 27,
      t = function() {
        this.element = $("#popup"), typeof USERAUTH != "undefined" && (this.showOnLoad = USERAUTH.popup, this.sessionActive = USERAUTH.active, this.showOnLoad && this.show());
        for (var e in this.events) {
          var t = this.events[e],
            n = e.split(/^(\S+)\s*(.*)$/);
          $(n[2] || document).on(n[1], this[t].bind(this))
        }
      };
    $.extend(t.prototype, {
      events: {
        "click .loginBtn": "show",
        "click .closeBtn": "hide",
        "click .loginNeeded": "loginNeeded",
        keyup: "keyUp"
      },
      show: function() {
        var e = arguments[0] || {};
        return this.element.show(), this.element.find("#username").focus(), this.setReturnTo(e.returnTo), !1
      },
      hide: function() {
        return this.showOnLoad ? history.back() : this.element.fadeOut(), !1
      },
      keyUp: function(t) {
        t.keyCode == e && this.hide()
      },
      loginNeeded: function(e) {
        var t = $(e.target).closest("a");
        if (!this.sessionActive) return this.show({
          returnTo: t.attr("href")
        }), !1
      },
      setReturnTo: function(e) {
        var t = this.element.find("input[name=_return_to]");
        if (e == null) {
          t.remove();
          return
        }
        if (t.length == 0) {
          var n = this.element.find("form");
          t = $("<input>").attr({
            type: "hidden",
            name: "_return_to"
          }).appendTo(n)
  ...
  function(e) {
    ...
    function n() {
      $(this).children("ul").show().removeClass("fadeOutDown").addClass("animated fadeInUp")
    }

    function r() {
      $(this).children("ul").removeClass("fadeInUp").fadeOut()
    }
    $("a[data-like]").click(function(e) {
      e.preventDefault();
      var t = $(e.target).closest(".postLike").data("like"),
        n = window.location.origin + "/votes/" + t,
      ...
      $.ajax({
        ...
        success: function(t, n, r) {
          $(e.target).closest(".articleSide").find(".likes").html(t.count)
        },
    ...
    $("#calloutStory .type").css("background-size", t + "px 1px"), $("#subHeader ul li").hoverIntent({
      over: n,
      timeout: 500,
      out: r
      ...
      var e = window.setTimeout(function() {
        $(".upVote").removeClass("animated bounce")
      }, 1300);
      return !1
    })
  });